class BigNumberCardIcon extends HTMLElement {
  ...
  setConfig(config) {
    ...
    style.textContent = `
      ha-card {
        ...
        padding: calc(var(--base-unit)*0.4) calc(var(--base-unit)*0.3);
...
customElements.define('bignumber-card-icon', BigNumberCardIcon);
